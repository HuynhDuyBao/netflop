...
export const authApi = {
  ...
  confirmForgotPassword: (data) => axiosClient.post('/auth/confirm-forgot-password', data),
  challenge: (data) => axiosClient.post('/auth/challenge', data),
  socialUrl: (params) => axiosClient.get('/auth/social-url', { params }),
  googleUrl: (params) => axiosClient.get('/auth/google-url', { params }),
  ...
  googleCallback: (data) => axiosClient.post('/auth/google-callback', data),
